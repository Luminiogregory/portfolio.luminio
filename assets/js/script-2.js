...
window.addEventListener('scroll',function(){
    ...
    const topElementToTopViewport = croquis.getBoundingClientRect().top;
    
    if(scrollTop > (scrollTop + topElementToTopViewport).toFixed() - clientHeight * 0.80){
      croquis.classList.add('image_block_20Apparait')
    }
})

const container = document.querySelector(".carousel-card");
